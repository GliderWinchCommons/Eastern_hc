...
public class ProfileManagementFrame implements Observer {
    ...
    public void ResetButton_Click(javafx.event.ActionEvent e) {
        ...
        ProfileGliderPanel.stallSpeedComboBox.setValue("kn");
        ProfileGliderPanel.weakLinkStrengthComboBox.setValue("lbf");
        ProfileGliderPanel.maxWinchingSpeedComboBox.setValue("kn");;
        ...
        ProfileOtherPanel.avgWindSpeedComboBox.setValue("kn");
        ProfileOtherPanel.crosswindComboBox.setValue("kn");
        ProfileOtherPanel.densityAltitudeComboBox.setValue("ft");
        ProfileOtherPanel.gustWindSpeedComboBox.setValue("kn");
        ProfileOtherPanel.headwindComboBox.setValue("kn");
        ProfileOtherPanel.launchWeightComboBox.setValue("lbs");
        ProfileOtherPanel.pressureComboBox.setValue("inHg");
